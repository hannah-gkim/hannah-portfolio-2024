  ...
  return (
    <div className="fixed top-4 right-2.5 xs:right-4 z-50 group">
      ...
      <audio ref={audioRef} loop>
        <source src={"/audio/mysterious-grove.mp3"} type="audio/mpeg" />
      ...
      <motion.button
        ...
        animate={{ scale: 1 }}
        transition={{ delay: 1 }}
        className="w-14 h-14 text-foreground rounded-full flex items-center justify-center cursor-pointer z-50 p-2.5 xs:p-4 custom-bg"
        // xs:w-14 xs:h-14
